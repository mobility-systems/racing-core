...
public class CacheConfig implements CachingConfigurer {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory, CacheProperties cacheProperties
        ...
        perCache.put(CacheNames.ALL_CAR_INFO_BY_ID, defaults.entryTtl(Duration.ofMinutes(30)));
        perCache.put(CacheNames.CAR_MODEL_BY_ID, defaults.entryTtl(Duration.ofSeconds(30)));
